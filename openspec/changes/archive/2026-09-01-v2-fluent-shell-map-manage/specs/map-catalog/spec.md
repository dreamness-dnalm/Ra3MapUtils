...
This capability MUST NOT delete, rename, copy, move, or compress map directories. Destructive or mutating map operations are out of scope.

#### Scenario: No mutating actions required
- **WHEN** the user uses the first-version map management page
- **THEN** listing and refresh MUST work without providing delete/rename/copy/compress actions
