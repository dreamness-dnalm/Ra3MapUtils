...
public partial class FastHashCalculatorWindowViewModel : ObservableObject
{
    ...
    [ObservableProperty] private bool _isHexOutput;

    [ObservableProperty] private string _inputText = "";

    [ObservableProperty] private string _outputText = "";

    partial void OnInputTextChanged(string value) => RefreshOutput();

    partial void OnIsCaseInsensitiveChanged(bool value) => RefreshOutput();

    partial void OnIsHexOutputChanged(bool value) => RefreshOutput();
    ...
    private void CopyOutput()
    {
        ...
        try
        {
            Clipboard.SetDataObject(OutputText, true);
        }
        catch
        {
