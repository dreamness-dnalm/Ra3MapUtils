...
public class MapFileSelectorDialog: BaseDialog
{
    public static Form Create(string title="选择地图文件")
    {
        ...
        okButton.Click += (sender, e) =>
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show(dialog, "请先选择地图文件！", "提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            {
                System.Windows.Forms.MessageBox.Show(dialog, "选择的文件不存在！", "错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
                dialog.DialogResult = DialogResult.None;
                return;
            }
